...
This outlines how to propose a change to USAboundariesData. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/USAboundariesData", fork = TRUE)`.
...
Please note that the USAboundariesData project is released with a
